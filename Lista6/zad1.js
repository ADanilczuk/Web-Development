...
$(document).ready(function() {
    ...
    $("#generate_text").click(function() {
        let statement = randomWord(adverbs) + " " + randomWord(verbs) + " " + randomWord(adjectives) + " " + randomWord(nouns);
        console.log(statement);
        $("#generated_value").val(statement);
    });
    $("#adverbs").append(adverbs.join("<br>"));

    $("#verbs").append(verbs.join("<br>"));

    $("#adjectives").append(adjectives.join("<br>"));

    $("#nouns").append(nouns.join("<br>"));
